...
public class DeliveryByCarDetailsSingleAdapter extends BaseAdapter {
    private List<ScanRec> list = null;
    private LayoutInflater layoutInflater = null;
    private Context context;
    private DeliveryByCarDetailsSingleAdapter.ViewHolder viewHolder = null;
    public DeliveryByCarDetailsSingleAdapter(Context context, List<ScanRec> list) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            viewHolder = new DeliveryByCarDetailsSingleAdapter.ViewHolder();
            ...
            viewHolder = (DeliveryByCarDetailsSingleAdapter.ViewHolder) convertView.getTag();
        }
